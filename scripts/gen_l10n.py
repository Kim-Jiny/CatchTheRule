...
T = {
 ...
 "logic_chapter_1": ["Logic Warm-up","논리 입문","ロジック入門","逻辑入门","Calentamiento lógico","Échauffement logique","Logik-Aufwärmen"],
 "logic_chapter_2": ["Order & Ranking","순서와 서열","順番と序列","顺序与排名","Orden y rango","Ordre et rang","Reihenfolge & Rang"],
 "logic_chapter_3": ["Matching & Clues","짝과 조건","対応と条件","配对与线索","Emparejar y pistas","Associations et indices","Zuordnung & Hinweise"],
 "logic_chapter_4": ["Truth & Lies","참과 거짓","真実と嘘","真话与谎言","Verdad y mentira","Vrai et faux","Wahrheit & Lüge"],
 "logic_chapter_5": ["Master Deduction","종합 추리","総合推理","综合推理","Deducción maestra","Déduction experte","Meister-Deduktion"],
 "logic_chapter_6": ["Analogy & Odd One","유추와 무리찾기","アナロジーと仲間はずれ","类比与找不同","Analogía y el intruso","Analogie et intrus","Analogie & Außenseiter"],
 ...
 "logic_chapter_11": ["Codes & Ciphers","암호와 부호","暗号と記号","密码与暗号","Códigos y claves","Codes et chiffres","Codes & Chiffren"],
 "logic_chapter_12": ["Balance & Weighing","저울 추리","天秤の推理","天平称重","Balanza y peso","Balance et pesée","Waage & Wiegen"],
 "logic_chapter_13": ["Sets & Counting","집합과 셈","集合と数え方","集合与计数","Conjuntos y conteo","Ensembles et comptage","Mengen & Zählen"],
