...
T = {
 ...
 "home_wait_update": ["New stages coming soon — stay tuned! 🎉","새로운 단계 업데이트를 기다려 주세요 🎉","新しいステージは近日追加予定です。お楽しみに！🎉","新关卡即将上线，敬请期待！🎉","¡Pronto habrá nuevos niveles! 🎉","De nouveaux niveaux arrivent bientôt ! 🎉","Neue Level kommen bald! 🎉"],
 ...
 "mode_numbers": ["Find the Rule","규칙찾기","ルール探し","找规律","Encuentra la regla","Trouve la règle","Finde die Regel"],
 "mode_shapes": ["Rules in Shapes","도형에서 규칙찾기","図形のルール探し","图形找规律","Reglas en figuras","Règles des formes","Regeln in Formen"],
 "mode_logic": ["Logic Puzzles","논리 퍼즐","ロジックパズル","逻辑谜题","Acertijos de lógica","Énigmes de logique","Logikrätsel"],
 "mode_contradiction": ["Spot the Contradiction","모순 찾기","矛盾さがし","找出矛盾","Encuentra la contradicción","Trouve la contradiction","Finde den Widerspruch"],
 "shape_chapter_1": ["Shapes & Numbers","도형과 숫자","図形と数","图形与数字","Formas y números","Formes et nombres","Formen & Zahlen"],
 "shape_chapter_2": ["Sums & Differences","합과 차","和と差","和与差","Sumas y restas","Sommes et différences","Summen & Differenzen"],
 "shape_chapter_3": ["Products & Patterns","곱셈의 규칙","かけ算の規則","乘法规律","Productos y patrones","Produits et motifs","Produkte & Muster"],
 "shape_chapter_4": ["Rotation & Symmetry","회전과 대칭","回転と対称","旋转与对称","Rotación y simetría","Rotation et symétrie","Drehung & Symmetrie"],
 "shape_chapter_5": ["Hidden Rules","숨은 규칙","隠れた規則","隐藏的规律","Reglas ocultas","Règles cachées","Versteckte Regeln"],
 "shape_chapter_6": ["Final Challenge","마지막 도전","最後の挑戦","最终挑战","Desafío final","Défi final","Letzte Herausforderung"],
 "shape_chapter_7": ["Expert Rules","고수의 규칙","達人の規則","高手规律","Reglas expertas","Règles expertes","Profi-Regeln"],
 "shape_chapter_8": ["Grandmaster","최상급","最上級","大师级","Gran maestro","Grand maître","Großmeister"],
 "shape_chapter_9": ["Legendary","전설","伝説","传说级","Legendario","Légendaire","Legendär"],
 "shape_chapter_10": ["Nonsense","넌센스","ナンセンス","脑筋急转弯","Sin sentido","Absurde","Verrückt"],
 "logic_chapter_1": ["Warm-up","입문","入門","入门","Calentamiento","Échauffement","Aufwärmen"],
 "logic_chapter_2": ["Easy","쉬움","やさしい","简单","Fácil","Facile","Leicht"],
 "logic_chapter_3": ["Basic","기초","基礎","基础","Básico","Basique","Grundlagen"],
 "logic_chapter_4": ["Moderate","보통","標準","普通","Moderado","Modéré","Mittel"],
 "logic_chapter_5": ["Intermediate","중급","中級","中级","Intermedio","Intermédiaire","Mittelstufe"],
 "logic_chapter_6": ["Tricky","까다로움","手ごわい","棘手","Enredado","Délicat","Knifflig"],
 "logic_chapter_7": ["Advanced","고급","上級","高级","Avanzado","Avancé","Fortgeschritten"],
 "logic_chapter_8": ["Hard","어려움","難しい","困难","Difícil","Difficile","Schwer"],
 "logic_chapter_9": ["Challenge","도전","挑戦","挑战","Desafío","Défi","Herausforderung"],
 "logic_chapter_10": ["Expert","고수","達人","高手","Experto","Expert","Experte"],
 "logic_chapter_11": ["Master","마스터","マスター","大师","Maestro","Maître","Meister"],
 "logic_chapter_12": ["Elite","최상급","最上級","精英","Élite","Élite","Elite"],
 "logic_chapter_13": ["Mensa","멘사","メンサ","门萨","Mensa","Mensa","Mensa"],
 "logic_chapter_14": ["Olympiad","올림피아드","オリンピアード","奥林匹克","Olimpiada","Olympiade","Olympiade"],
 "contradiction_chapter_1": ["Warm-up","입문","入門","入门","Calentamiento","Échauffement","Aufwärmen"],
 "contradiction_chapter_2": ["Easy","쉬움","やさしい","简单","Fácil","Facile","Leicht"],
 "contradiction_chapter_3": ["Basic","기초","基礎","基础","Básico","Basique","Grundlagen"],
 "contradiction_chapter_4": ["Moderate","보통","標準","普通","Moderado","Modéré","Mittel"],
 "contradiction_chapter_5": ["Intermediate","중급","中級","中级","Intermedio","Intermédiaire","Mittelstufe"],
 "contradiction_chapter_6": ["Tricky","까다로움","手ごわい","棘手","Enredado","Délicat","Knifflig"],
 "contradiction_chapter_7": ["Advanced","고급","上級","高级","Avanzado","Avancé","Fortgeschritten"],
 "contradiction_chapter_8": ["Hard","어려움","難しい","困难","Difícil","Difficile","Schwer"],
 "contradiction_chapter_9": ["Challenge","도전","挑戦","挑战","Desafío","Défi","Herausforderung"],
 "contradiction_chapter_10": ["Master","마스터","マスター","大师","Maestro","Maître","Meister"],
 "contradiction_chapter_11": ["Elite","최상급","最上級","精英","Élite","Élite","Elite"],
 "contradiction_chapter_12": ["Mensa","멘사","メンサ","门萨","Mensa","Mensa","Mensa"],
 "contradiction_chapter_13": ["Olympiad","올림피아드","オリンピアード","奥林匹克","Olimpiada","Olympiade","Olympiade"],
 "contradiction_prompt": ["Find the sentence that doesn't fit","앞뒤가 맞지 않는 문장을 찾으세요","つじつまの合わない文を見つけよう","找出前后矛盾的句子","Encuentra la frase que no encaja","Trouve la phrase qui ne colle pas","Finde den Satz, der nicht passt"],
 ...
 "mode_locked": ["Locked","잠김","ロック中","已锁定","Bloqueado","Verrouillé","Gesperrt"],
 "unlock_title": ["New Modes Unlocked!","새 모드 해금!","新モード解放！","新模式已解锁！","¡Nuevos modos desbloqueados!","Nouveaux modes débloqués !","Neue Modi freigeschaltet!"],
 "unlock_msg": ["You cleared 5 chapters! Three new modes are open — find the rules hidden in shapes, crack logic puzzles, and spot the contradiction in a story.","5챕터를 클리어했어요! 새로운 모드 세 개가 열렸어요 — 도형 속 규칙 찾기, 논리 퍼즐, 그리고 모순 찾기에 도전해 보세요.","5チャプタークリア！新しいモードが3つ解放 — 図形のルール探し、ロジックパズル、そして矛盾さがしに挑戦しよう。","通关5个章节！开启三种新模式 — 图形找规律、逻辑谜题，以及找出矛盾。","¡Superaste 5 capítulos! Se abrieron tres modos nuevos: encuentra las reglas en las figuras, resuelve acertijos de lógica y detecta la contradicción.","Tu as terminé 5 chapitres ! Trois nouveaux modes s'ouvrent — trouve les règles des formes, résous des énigmes de logique et repère la contradiction.","Du hast 5 Kapitel geschafft! Drei neue Modi sind offen — finde die Regeln in den Formen, löse Logikrätsel und entdecke den Widerspruch."],
 "unlock_ok": ["Let's go!","좋아요!","いいね！","好的！","¡Vamos!","C'est parti !","Los geht's!"],
 ...
 "my_version": ["Your version","내 버전","現在のバージョン","当前版本","Tu versión","Ta version","Deine Version"],
 "store_version": ["Store version","스토어 버전","ストアの最新","商店版本","Versión de la tienda","Version du store","Store-Version"],
 "version_up_to_date": ["You're on the latest version 👍","최신 버전이에요 👍","最新バージョンです 👍","已是最新版本 👍","Tienes la última versión 👍","Tu as la dernière version 👍","Du hast die neueste Version 👍"],
 "version_new_available": ["New puzzles are available!","새 문제가 업데이트되었어요!","新しい問題が追加されました！","有新题目可更新！","¡Hay nuevos acertijos disponibles!","De nouvelles énigmes sont disponibles !","Neue Rätsel sind verfügbar!"],
 "version_update_action": ["Update","업데이트","アップデート","更新","Actualizar","Mettre à jour","Aktualisieren"],
 "version_checking": ["Checking…","확인 중…","確認中…","检查中…","Comprobando…","Vérification…","Wird geprüft…"],
 ...
 "iap_remove_ads_note": ["Removing ads applies only to banner and interstitial ads. Free hints still require watching the “Watch an ad for a hint” rewarded ad.","광고 제거는 배너·전면 광고에만 적용됩니다. 힌트는 ‘광고 보고 힌트 받기’ 보상형 광고를 시청해야 받을 수 있어요.","広告削除はバナー・全面広告のみに適用されます。ヒントは「広告を見てヒント」リワード広告の視聴で獲得できます。","去广告仅适用于横幅和插页广告。提示仍需观看“看广告得提示”激励广告才能获得。","La eliminación de anuncios se aplica solo a banners e intersticiales. Para obtener pistas, deberás ver el anuncio recompensado “Ver un anuncio por una pista”.","La suppression des publicités s'applique uniquement aux bannières et interstitiels. Les indices nécessitent toujours de regarder la publicité avec récompense « Regarder une pub pour un indice ».","Die Werbeentfernung gilt nur für Banner- und Interstitial-Anzeigen. Tipps gibt es weiterhin nur über die Belohnungsanzeige „Werbung für einen Tipp ansehen“."],
