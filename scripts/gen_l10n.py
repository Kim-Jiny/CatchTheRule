...
T = {
 ...
 "unlock_title": ["Shape Rules Unlocked!","도형규칙 해금!","図形ルール解放！","图形规律已解锁！","¡Reglas de figuras desbloqueadas!","Règles des formes débloquées !","Formen-Regeln freigeschaltet!"],
 "unlock_msg": ["You cleared 5 chapters! A new mode is open — find the rules hidden in shapes.","5챕터를 클리어했어요! 새로운 모드가 열렸어요 — 도형 속 규칙을 찾아보세요.","5チャプタークリア！新しいモードが解放されました — 図形に隠れたルールを探そう。","通关5个章节！新模式已开启 — 找出图形中隐藏的规律。","¡Superaste 5 capítulos! Se abrió un nuevo modo: encuentra las reglas en las figuras.","Tu as terminé 5 chapitres ! Un nouveau mode s'ouvre — trouve les règles cachées dans les formes.","Du hast 5 Kapitel geschafft! Ein neuer Modus ist offen — finde die Regeln in den Formen."],
